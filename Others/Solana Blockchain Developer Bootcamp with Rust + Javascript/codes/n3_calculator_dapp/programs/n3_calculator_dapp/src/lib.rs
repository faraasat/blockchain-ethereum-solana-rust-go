...
#[program]
pub mod n3_calculator_dapp {
    use super::*;
    
    // first argument will always be context and it will contain solana account
...
pub struct Create<'info> {
    // Space means amount of space to be reserve on solana account
    #[account(init, payer=user, space=264)]
    pub calculator: Account<'info, Calculator>,
    // below line tells that our account will be mutable
    #[account(mut)]
